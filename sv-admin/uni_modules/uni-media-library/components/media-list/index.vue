      ...
      <view class="items" v-else-if="mediaList.length">
        ...
        >
          <view class="image" v-if="mediaItem.type === 'image'">
            <image :src="mediaItem.isUploading ? mediaItem.src: mediaItem.cover" mode="aspectFill" class="img"></image>
          </view>
          <view class="image" v-if="mediaItem.type === 'video'">
            ...
            ></video>
            <image v-else :src="mediaItem.cover" mode="aspectFill" class="img"></image>
          </view>
